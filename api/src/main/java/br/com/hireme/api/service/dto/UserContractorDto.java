...
public class UserContractorDto {
    ...
    public UserContractorDto(User user, Contractor contractor) {
    ...
    public static UserContractorDto toDto(User user, Contractor contractor) {
        return new UserContractorDto(user, contractor);
    }
}
